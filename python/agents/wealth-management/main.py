...
"""
This file initializes a FastAPI application for Wealth Management agent
...
embed Wealth Management agent within a custom FastAPI application.
...
web_interface_enabled = os.getenv("SERVE_WEB_INTERFACE", 'True').lower() in ('true', '1')
...
app.title = "wealth_management"
app.description = "Wealth Management Agent - Sophisticated AI orchestration for financial advisory services"
